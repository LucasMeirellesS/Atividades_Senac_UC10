 ...
 */
public class TelaAtualizaNome extends javax.swing.JFrame {
    
    /**
     * Creates new form TelaAtualizaNome
     */
    public TelaAtualizaNome() {
        initComponents();
    }
    ...
    private void btnAlteraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlteraActionPerformed
        ...
        if(!emptyFields()){
            if(validar()){
                ...
                filme.setNome(pegaNomeDeLa());
                filme.setNomeAlteracao(txtNome.getText());
                filme.setData(data);
                ...
                if(status == false){
                    ...
                    resposta = dao.atualizarNome(filme);
                    if(resposta == 1){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAtualizaNome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAtualizaNome().setVisible(true);
            }
        });
    }
    ...
    private TelaPesquisaNome telaI;
     /**
      * Função criada para iniciar a tela de atualização a partir da tela inicial
      * @param telainicial 
      */
    public void MostraTela(TelaPesquisaNome telainicial){
    ...
    /**
     * Chama a função atualizar da tela de pesquisa
     */
    public void atualizaDeNovo(){
        telaI.atualizar();
    }
    /**
     * Chama a função para pegar o nome utilizado na pesquisa da tela de pesquisa
     * @return 
     */
    public String pegaNomeDeLa(){
        return telaI.pegaNome();
    }
    
    /**
     * Verifica se os campos estão vazios, se houverem campos vazios, o método retornará true
